...
return false;
   ...
   return false;
    ...
    <h2>Edit Your Profile<br> 
    </h2>
    
    <div class="content_item">
        
        <form  name="f1" action="editprofiledetail.php" onsubmit="return validateForm(this);"  enctype="multipart/form-data"  method="post">
            ...
            <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="left" valign="top"><input type="text" name="first_name" id="firstname" value="<?php echo $username; ?>"size="35" /></td>

                    <td align="left" valign="top"><div id="fname" class="error"></div></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    ...
                    <td align="left" valign="top"><input type="text" name="last_name" id="lastname" value="<?php echo $lastname;?>" size="35" /></td>

                    <td align="left" valign="top"><div id="lname" class="error"></div></td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                            ...
                            if($gender=="Male" || $gender=="male"){
                             echo'<label>
                                  <input type="radio" name="gender" value="Male" id="sex_0" checked/>
                                    Male</label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <label>
                             ...
                             echo'<label>
                                  <input type="radio" name="gender" value="Male" id="sex_0"/>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <label>
                                <input type="radio" name="gender" value="Female" id="sex_1" checked />
                                    Female</label>';
                            }
                            ?>
                ...
                <tr>
                    ...
                    <td align="left" valign="top"><input type="text" name="email" id="eml" size="35" value="<?php echo $email; ?>" /></td>

                    <td align="left" valign="top"><div id="mail" class="error"></div></td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="left" valign="top"><input type="text" name="mob_no" id="mobno" maxlength="10" value="<?php echo $mobno; ?>"/></td>

                    <td align="left" valign="top"><div id="mob" class="error"></div></td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="2" align="left" valign="top">
                        ...
                        <select name="birth_day">
                            <option value="<?php echo $bday;?>" selected="selected"><?php echo $bday;?></option>
                        ...
                        <select name="birth_month">
                            <option value="<?php echo $bmonth;?>" selected="selected"><?php echo $bmonth;?></option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
                        ...
                        <input type="number" name="birth_year" id="birthyear" value="<?php echo $byear; ?>"size="4">
                        <br>
                        <span>
                            (DD&nbsp;-&nbsp;MM&nbsp;&nbsp;-&nbsp;YYYY)
                        </span> 
                        <div id="byear" class="error"></div>
                        </td>
                </tr>
                <tr><td></td></tr>
                ...
                <tr>
                    ...
                    <td align="center" valign="top">:</td>
                    <td colspan="2" align="left" valign="top"><textarea name="address" id="paddress" cols="40" rows="3" ><?php echo $address; ?> </textarea>      &nbsp;&nbsp;&nbsp;&nbsp;
                   </td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <select name="passing_year">
                            <option value="<?php echo $pass_year; ?>" selected="selected"><?php echo $pass_year; ?></option>
                ...
                <tr>
                    ...
                    <td align="left" valign="top"><input type="text" name="current_employer" size="35" value="<?php echo $current_emp; ?>" /></td>
                ...
                <tr>
                    ...
                    <td align="left" valign="top"><input type="text" name="current_possition" size="35" value="<?php echo $current_pos; ?>"/></td>
